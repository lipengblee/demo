...
public class StoreManagementConvertImpl implements StoreManagementConvert {
    ...
    public StoreOrderDetailRespVO convertOrderDetail(TradeOrderDO order, List<TradeOrderItemDO> orderItems, PrintDeviceDO assignedDevice, Integer printProgress, List<StoreOrderDetailRespVO.OrderLogVO> logs) {
        ...
        if ( order != null ) {
            ...
            storeOrderDetailRespVO.setDiscountPrice( order.getDiscountPrice() );
            storeOrderDetailRespVO.setDeliveryPrice( order.getDeliveryPrice() );
            storeOrderDetailRespVO.setTotalPrice( order.getTotalPrice() );
        }
    ...
    protected StoreDeviceRespVO printDeviceDOToStoreDeviceRespVO(PrintDeviceDO printDeviceDO) {
        ...
        storeDeviceRespVO.setAddress( printDeviceDO.getAddress() );
        storeDeviceRespVO.setConnectionType( printDeviceDO.getConnectionType() );
        ...
        storeDeviceRespVO.setPort( printDeviceDO.getPort() );
        storeDeviceRespVO.setRemark( printDeviceDO.getRemark() );
