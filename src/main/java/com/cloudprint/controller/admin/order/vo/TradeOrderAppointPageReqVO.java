...
@Schema(description = "管理后台 - 指派门店交易订单的分页 Request VO")
@Data
public class TradeOrderAppointPageReqVO extends PageParam {
    ...
    @Schema(description = "指派门店编号", example = "[1,2]")
    private List<Long> appointStoreIds;
