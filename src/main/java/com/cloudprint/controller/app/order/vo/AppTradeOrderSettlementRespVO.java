...
public class AppTradeOrderSettlementRespVO {
    ...
    public static class Item {
        ...
        @Schema(description = "开始页码", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
        private Integer pageStart;

        @Schema(description = "结束页码", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
