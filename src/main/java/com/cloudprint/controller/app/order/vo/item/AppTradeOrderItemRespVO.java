package com.star.lp.module.trade.controller.app.order.vo.item;
...
public class AppTradeOrderItemRespVO {
    ...
    private Long spuId;
    @Schema(description = "商品 SPU 名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "LP Code")
    ...
    @Schema(description = "打印开始页")
    private Integer pageStart;
    
    @Schema(description = "打印结束页")
