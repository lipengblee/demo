...
public interface TradeOrderUpdateService {
     ...
     * @param reqVO 请求
     */
    void updateOrderAppointStoreId(TradeOrderAppointStoreIdReqVO reqVO);
    ...
    void updateOrderStatusToFailed(Long orderId, String errorMessage);

    void updateOrderStatusToFailedWithDetail(Long orderId, String errorMessage, String logisticsDetail);

    boolean updateOrderLogisticsInfo(Long orderId, String logisticsNo, String logisticsDetail, Long storeId);
