package com.star.lp.module.trade.service.order.handler;
...
import com.star.lp.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.star.lp.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "star.trade.order", value = "status-sync-to-wxa-enable")
