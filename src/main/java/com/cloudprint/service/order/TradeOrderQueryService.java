...
public interface TradeOrderQueryService {
     ...
     * @return 交易订单
     */
    PageResult<TradeOrderDO> getAppointStoreOrderPage(TradeOrderAppointPageReqVO reqVO);
     ...
     * @return 订单统计
     */
    TradeOrderSummaryRespVO getAppointStoreOrderSummary(TradeOrderAppointPageReqVO reqVO);
     ...
     * @return 订单列表
     */
    List<TradeOrderDO> getOrdersByLogisticsNo(String logisticsNo);
     ...
     * @return 最新的一条订单
     */
    TradeOrderDO getLatestOrderByLogisticsNo(String logisticsNo);
     ...
     * @return 订单信息
     */
    TradeOrderDO getOrderByNo(String orderNo);
    ...
    List<ProductPrintDocumentSpuDO> selectBySpuIds(Collection<Long> orderIds);
