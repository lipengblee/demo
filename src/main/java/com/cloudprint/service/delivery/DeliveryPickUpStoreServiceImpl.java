...
public class DeliveryPickUpStoreServiceImpl implements DeliveryPickUpStoreService {
    ...
    @Override
    public DeliveryPickUpStoreDO getDeliveryPickUpStoreByStoreOperationUserId(Long userId) {
        return deliveryPickUpStoreMapper.selectByStoreOperationUserId(userId);
    }
    
    @Override
    public DeliveryPickUpStoreDO getLatestPickUpStoreByVerifyUserId(Long verifyUserId) {
        return deliveryPickUpStoreMapper.selectLatestByVerifyUserId(verifyUserId);
    }
