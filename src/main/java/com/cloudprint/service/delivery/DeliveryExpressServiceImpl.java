...
import com.star.lp.module.trade.controller.admin.delivery.vo.express.DeliveryExpressExportReqVO;
import com.star.lp.module.trade.controller.admin.delivery.vo.express.DeliveryExpressPageReqVO;
import com.star.lp.module.trade.controller.admin.delivery.vo.express.DeliveryExpressUpdateReqVO;
import com.star.lp.module.trade.convert.delivery.DeliveryExpressConvert;
import com.star.lp.module.trade.dal.dataobject.delivery.DeliveryExpressDO;
import com.star.lp.module.trade.dal.mysql.delivery.DeliveryExpressMapper;
...
public class DeliveryExpressServiceImpl implements DeliveryExpressService {
    ...
    @Override
    public DeliveryExpressDO getDeliveryExpressByName(String name) {
        return deliveryExpressMapper.selectByName(name);
    }
