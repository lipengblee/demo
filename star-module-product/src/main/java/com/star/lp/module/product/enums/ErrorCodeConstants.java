...
public interface ErrorCodeConstants {
    ...
    // ========== 云打印 属性 1-008-009-000 ==========
    ErrorCode PRINT_CONFIG_NOT_EXISTS = new ErrorCode(1_008_009_001, "打印设置配置不存在");
    ErrorCode PROPERTY_VALUE_NOT_MATCH_PROPERTY = new ErrorCode(1_008_009_002, "打印价格不匹配");
