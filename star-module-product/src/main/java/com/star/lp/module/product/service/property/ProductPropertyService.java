...
import com.star.lp.module.product.controller.admin.property.vo.property.*;
...
public interface ProductPropertyService {
    ...
    ProductPropertyDO getPropertyByName(String propertyName);

    List<ProductPropertyDO> getPropertyListByProductType(Integer productType);
}
