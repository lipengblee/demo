package com.star.lp.module.product.service.property;
...
import com.star.lp.module.product.controller.admin.property.vo.value.ProductPropertyValuePageReqVO;
import com.star.lp.module.product.controller.admin.property.vo.value.ProductPropertyValueSaveReqVO;
import com.star.lp.module.product.dal.dataobject.property.ProductPropertyValueDO;
import com.star.lp.module.product.dal.mysql.property.ProductPropertyValueMapper;
...
import static com.star.lp.module.product.enums.ErrorCodeConstants.PROPERTY_VALUE_EXISTS;
import static com.star.lp.module.product.enums.ErrorCodeConstants.PROPERTY_VALUE_NOT_EXISTS;
...
public class ProductPropertyValueServiceImpl implements ProductPropertyValueService {
    ...
    @Override
    public List<ProductPropertyValueDO> getPropertyValueListByIds(Collection<Long> valueIds) {
        if (CollUtil.isEmpty(valueIds)) {
            return ListUtil.empty();
        }
        return productPropertyValueMapper.selectByIds(valueIds); // 调用MyBatis的selectByIds方法
    }
