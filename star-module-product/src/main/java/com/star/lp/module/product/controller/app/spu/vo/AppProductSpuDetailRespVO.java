package com.star.lp.module.product.controller.app.spu.vo;

import com.star.lp.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    public static class PrintDocument {
        ...
        @Schema(description = "文档名称", example = "合同文件.pdf")
        private String name;
