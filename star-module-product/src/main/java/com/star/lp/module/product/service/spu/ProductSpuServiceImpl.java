package com.star.lp.module.product.service.spu;
...
import com.star.lp.module.product.controller.admin.spu.vo.ProductSpuUpdateStatusReqVO;
...
import com.star.lp.module.product.dal.mysql.sku.ProductSkuMapper;
import com.star.lp.module.product.dal.mysql.spu.ProductSpuMapper;
import com.star.lp.module.product.enums.spu.ProductSpuStatusEnum;
import com.star.lp.module.product.service.brand.ProductBrandService;
import com.star.lp.module.product.service.category.ProductCategoryService;
...
import static com.star.lp.module.product.dal.dataobject.category.ProductCategoryDO.CATEGORY_LEVEL;
...
public class ProductSpuServiceImpl implements ProductSpuService {
    ...
    public List<Long> getSkuIdsBySpuId(Long spuId) {
        // 查询SPU关联的所有SKU
        List<ProductSkuDO> skus = productSkuMapper.selectListBySpuId(spuId);
        return skus.stream().map(ProductSkuDO::getId).collect(Collectors.toList());
    }
