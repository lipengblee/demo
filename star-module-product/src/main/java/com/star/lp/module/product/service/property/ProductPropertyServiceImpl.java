...
import com.star.lp.module.product.controller.admin.property.vo.property.ProductPropertySaveReqVO;
import com.star.lp.module.product.dal.dataobject.property.ProductPropertyDO;
import com.star.lp.module.product.dal.mysql.property.ProductPropertyMapper;
...
public class ProductPropertyServiceImpl implements ProductPropertyService {
    ...
    public ProductPropertyDO getPropertyByName(String name){
        return productPropertyMapper.selectByName(name);
    }

    public List<ProductPropertyDO> getPropertyListByProductType(Integer productType) {
        return productPropertyMapper.selectListByProductType(productType);
    }
}
