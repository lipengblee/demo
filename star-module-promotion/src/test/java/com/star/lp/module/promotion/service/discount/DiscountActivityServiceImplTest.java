package com.star.lp.module.promotion.service.discount;

import com.star.lp.framework.common.pojo.PageResult;
import com.star.lp.framework.test.core.ut.BaseDbUnitTest;
import com.star.lp.module.promotion.controller.admin.discount.vo.DiscountActivityBaseVO;
import com.star.lp.module.promotion.controller.admin.discount.vo.DiscountActivityCreateReqVO;
import com.star.lp.module.promotion.controller.admin.discount.vo.DiscountActivityPageReqVO;
import com.star.lp.module.promotion.controller.admin.discount.vo.DiscountActivityUpdateReqVO;
import com.star.lp.module.promotion.dal.dataobject.discount.DiscountActivityDO;
import com.star.lp.module.promotion.dal.dataobject.discount.DiscountProductDO;
import com.star.lp.module.promotion.dal.mysql.discount.DiscountActivityMapper;
import com.star.lp.module.promotion.dal.mysql.discount.DiscountProductMapper;
import com.star.lp.module.promotion.enums.common.PromotionActivityStatusEnum;
import com.star.lp.module.promotion.enums.common.PromotionDiscountTypeEnum;
...
import static com.star.lp.framework.common.util.date.LocalDateTimeUtils.addTime;
import static com.star.lp.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.star.lp.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.star.lp.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.star.lp.framework.test.core.util.AssertUtils.assertServiceException;
import static com.star.lp.framework.test.core.util.RandomUtils.randomLongId;
import static com.star.lp.framework.test.core.util.RandomUtils.randomPojo;
import static com.star.lp.module.promotion.enums.ErrorCodeConstants.DISCOUNT_ACTIVITY_NOT_EXISTS;
